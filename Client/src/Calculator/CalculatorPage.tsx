...
export default function CalculatorPage() {
  return (
    ...
    >  <Box sx={{ display: "flex", alignContent: "center", justifyContent: 'center', flexDirection:"column", gap: 3 ,boxShadow:4 ,px:2,mt:2 ,mb:2,borderRadius:2}}>
        <Box sx={{ p: 2}}>
          <Typography  variant="h4" align="center" sx={{letterSpacing:-0.4}}>Calculator Investiții</Typography>
