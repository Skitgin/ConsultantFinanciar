  ...
  return (
    <Card sx={{ bgcolor: '#494D5F', maxWidth: "auto", width: 500, height: 670, borderRadius: 4, mt: 0, boxShadow: 4, justifyContent: "space-between", alignContent: "start", flexDirection: "column" }}>
      ...
      <CardHeader sx={{ mt: 5, display: 'flex', justifyContent: 'center', alignContent: "start", height: 120 }}
        avatar={
          <><Avatar slotProps={{img :{fetchPriority: "high",  loading: "eager"}}} src={consultant.imageUrl} alt={consultant.nume} sx={{ border: '3px solid #f8a100', height: 120, width: 120, ml: 3, display: 'flex', justifyContent: 'center', alignContent: 'center', boxShadow: 3 }} aria-label="recipe">
            ...
            <Box sx={{ display: "flex", flexDirection: "column", px: 4, mt: 2 }}>
              ...
              <Typography  variant="body1" color='White' align='center' sx={{ display: 'flex', justifyContent: 'center', alignContent: 'center' }}>
