    ...
    private static void SeedData(ReviewContext context)
    {
        ...
        var consultants = new List<Consultant>
        {
            ...
            new Consultant
            {
                ...
                Descriere = "Descriere Personala: /n Am descoperit lumea finanțelor nu din manuale, ci din realitatea vieții de zi cu zi — atunci când am realizat cât de greu este să trăiești fără o siguranță financiară reală.Am văzut oameni muncitori, inteligenți, care își pierd liniștea nu pentru că nu câștigă suficient, ci pentru că nu știu cum să gestioneze eficient ceea ce au./n Așa a început drumul meu./nDupă ce am absolvit studiile economice și m-am specializat în domeniul financiar, am obținut și acreditarea oficială ISF (Institutul de Studii Financiare), iar de atunci, mi-am propus o misiune clară: să-i ajut pe români să scape de povara unei situații financiare instabile și să își construiască, pas cu pas, un plan care le aduce siguranță, echilibru și libertate./n Cred că educația financiară nu este un lux, ci o nevoie de bază, iar scopul meu este să fac acest proces accesibil, realist și mai ales, potrivit, pentru ca oricine să poată trăi o viață fără stresul banilor și cu mai multă încredere în propriul viitor.",
